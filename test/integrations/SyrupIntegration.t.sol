...
contract SyrupIntegrationTest is Test, MerkleTreeHelper {
    ...
    function setUp() external {
        ...
        rawDataDecoderAndSanitizer = address(new FullSyrupDecoderAndSanitizer());
    ...
    function testSyrupIntegration() external {
        ...
        // auth boringVault to call deposit instead of authDeposit
        IPoolPermissionManager permManager = IPoolPermissionManager(0xBe10aDcE8B6E3E02Db384E7FaDA5395DD113D8b3);
        address poolManagerUSDC = 0x7aD5fFa5fdF509E30186F4609c2f6269f4B6158F;
        address poolManagerUSDT = 0x0cdA32E08B48bFDDbc7eE96B44b09cf286F9E21a;
        address[] memory lenders_ = new address[](1);
        lenders_[0] = address(boringVault);
        bool[] memory booleans_ = new bool[](1);
        booleans_[0] = true;
        vm.startPrank(0xd6d4Bcde6c816F17889f1Dd3000aF0261B03a196);
