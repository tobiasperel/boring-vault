...
contract AaveV3IntegrationTest is Test, MerkleTreeHelper {
    ...
    function testHoneyMintAndRedeemWithUSDC() external {
    ...
    function testHoneyMintAndRedeemWithUSDT() external {
        deal(getAddress(sourceChain, "USDT"), address(boringVault), 100e6);
...
contract FullHoneyDecoderAndSanitizer is HoneyDecoderAndSanitizer {}
