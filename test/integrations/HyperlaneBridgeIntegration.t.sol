...
contract HyperlaneBridgeIntegrationTest is Test, MerkleTreeHelper {
    ...
    function testHyperlaneBridging() external {
        ...
        _addLeafsForHyperlane(
            ...
            getBytes32(sourceChain, "hyperlaneTestRecipient"),
            getERC20(sourceChain, "USDC"),
            getAddress(sourceChain, "hyperlaneUsdcRouter")
        );
        ...
        targets[1] = getAddress(sourceChain, "hyperlaneUsdcRouter");

        bytes[] memory targetData = new bytes[](2);
        targetData[0] =
            abi.encodeWithSignature("approve(address,uint256)", getAddress(sourceChain, "hyperlaneUsdcRouter"), 100e6);
