...
contract SymbioticVaultIntegrationTest is Test, MerkleTreeHelper {
    ...
    function testSymbioticVaultIntegrationMainnet() external {
        ...
        targetData[0] = abi.encodeWithSelector(
            ERC20.approve.selector, getAddress(sourceChain, "wstETHSymbioticVault"), type(uint256).max
        );
        targetData[1] = abi.encodeWithSignature("deposit(address,uint256)", boringVault, 100e18);
    ...
    function testSymbioticVaultIntegrationMainnetRewards() external {
...

        {
            ...
            vm.mockCall(
                ...
                abi.encodeWithSelector(
                    INetworkMiddlewareService.middleware.selector, 0x96d37DC47CBE2486E25c4a4587FFCdc48cDd3172
                ),
        ...
        targetData[0] = abi.encodeWithSignature(
            "claimRewards(address,address,bytes)", boringVault, getAddress(sourceChain, "WETH"), data
        );
