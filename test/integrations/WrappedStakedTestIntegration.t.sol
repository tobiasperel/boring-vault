...
contract AaveV3IntegrationTest is Test, MerkleTreeHelper {
    ...
    function testWrappedStakedUSD() external {
        ...
        targetData[0] =
            abi.encodeWithSignature("approve(address,uint256)", stkscUSDAccountant, type(uint256).max);
        targetData[1] =
            abi.encodeWithSignature("claimYield(address)", getAddress(sourceChain, "scUSD"));
