...
/**
 *  source .env && forge script script/MerkleRootCreation/Mainnet/CreateAlphaSTETHMerkleRoot.s.sol:CreateAlphaSTETHMerkleRoot --rpc-url $MAINNET_RPC_URL
 */
contract CreateAlphaSTETHMerkleRoot is Script, MerkleTreeHelper {
    ...
    function generateMerkleRoot() public {
        ...
        string memory filePath = "./leafs/Mainnet/AlphaSTETH.json";
