 ...
 */
contract DeployLayerZeroTellerScript is Script, ContractNames, BaseAddresses {
    ...
    address internal vault = 0x657e8C867D8B37dCC18fA4Caead9C45EB088C642;
    ...
    function run() external {
        ...
        constructorArgs = abi.encode(dev1Address, vault, accountant, weth, lzEndPoint, delegate, address(0));
