...
contract DeployDecoderAndSanitizerScript is Script, ContractNames, MainnetAddresses, MerkleTreeHelper {
    ...
    function run() external {
        ...
        creationCode = type(FullCorkDecoderAndSanitizer).creationCode;
        constructorArgs = abi.encode();
        deployer.deployContract("ITB Cork Position Manager Decoder And Sanitizer V0.0", creationCode, constructorArgs, 0);
