...
import {cbBtcDefiVaultDecoderAndSanitizer} from "src/base/DecodersAndSanitizers/cbBtcDefiVaultDecoderAndSanitizer.sol";

/**
 *  source .env && forge script script/ArchitectureDeployments/Base/DeployCbBtcDefiVault.s.sol:DeployCbBtcDefiVaultScript --with-gas-price 3000000 --broadcast --etherscan-api-key $BASESCAN_KEY --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployCbBtcDefiVaultScript is DeployArcticArchitecture, BaseAddresses {
    ...
    function run() external {
        ...
        names.rawDataDecoderAndSanitizer = CbBtcDefiVaultDecoderAndSanitizerName;
        names.delayedWithdrawer = CbBtcDefiVaultDelayedWithdrawer;
