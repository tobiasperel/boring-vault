...
/**
 *  source .env && forge script script/ArchitectureDeployments/Arbitrum/DeployTestCCIPTeller.s.sol:DeployTestCCIPTellerScript --with-gas-price 10000000 --evm-version london --slow --broadcast --etherscan-api-key $ARBISCAN_KEY --verify
 * @dev Optionally can change `--with-gas-price` to something more reasonable
 */
contract DeployTestCCIPTellerScript is Script, ArbitrumAddresses, ContractNames {
    ...
    function run() external {
        ...
        teller.addChain(OPTIMISM_SELECTOR, true, true, address(teller), 100_000);
